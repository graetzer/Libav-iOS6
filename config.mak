...
LIBAV_CONFIGURATION=--cc=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/usr/bin/gcc --as='/usr/local/bin/gas-preprocessor.pl /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/usr/bin/gcc' --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator6.0.sdk --target-os=darwin --arch=i386 --cpu=i386 --extra-cflags='-arch i386' --extra-ldflags='-arch i386 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator6.0.sdk' --prefix=compiled/i386 --enable-cross-compile --enable-nonfree --enable-gpl --enable-encoder=mpeg1video --enable-encoder=mpeg4 --disable-armv5te --disable-swscale-alpha --disable-doc --disable-ffmpeg --disable-avplay --disable-avprobe --disable-avserver --disable-asm --disable-debug
...
RANLIB=ranlib
LN_S=ln -sf
CPPFLAGS= --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator6.0.sdk -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE
CFLAGS= -arch i386 -march=i386 -std=c99 -mdynamic-no-pic -fomit-frame-pointer -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wundef -Wmissing-prototypes -Wstrict-prototypes -O3 -fno-math-errno -mllvm -stack-alignment=16
ASFLAGS= -arch i386 -march=i386 -mdynamic-no-pic
AS_O=-o $@
CC_O=-o $@
DLLTOOL=
LDFLAGS= -arch i386 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator6.0.sdk --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator6.0.sdk -Wl,-dynamic,-search_paths_first
